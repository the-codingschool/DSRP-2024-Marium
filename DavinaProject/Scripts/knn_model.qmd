...
```{r}
knn_model <- knn(train = train_data[, c('distance','start_lon','start_lat','end_lat','end_lon','classic_bike')], 
                 test = test_data[, c('distance','start_lon', 'start_lat', 'end_lat', 'end_lon','classic_bike')], 
...
#c('distance','start_lon','start_lat','end_lat','end_lon','start_station_id_hash', 'end_station_id_hash', 'start_hour', 'classic_bike', 'weekend')
#k=6

#'start_station_id_hash', 'end_station_id_hash','classic_bike','start_hour'

#, 'start_hour', 'classic_bike', 'weekend'

#'member','classic_bike'
#'start_hour', 'classic_bike'
#'start_station_id_hash', 'end_station_id_hash',
```
