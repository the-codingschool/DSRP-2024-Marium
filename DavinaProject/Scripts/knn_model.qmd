...
trip_distance <- ifelse(mapply(compute_distance, data_original$start_lng, data_original$start_lat, data_original$end_lng, data_original$end_lat) <= 1500, mapply(compute_distance, data_original$start_lng, data_original$start_lat, data_original$end_lng, data_original$end_lat)/1000, NA)
...
trial_data <- data_frame(
  ...
  end_station_id_hash = conv_data$start_station_id_hashed,
  start_hour = hour(conv_data$start_timeform),
  distance = mapply(compute_distance, data_original$start_lng, data_original$start_lat, data_original$end_lng, data_original$end_lat)/1000,
  start_lon = data_original$start_lng,
  start_lat = data_original$start_lat,
  end_lat = data_original$end_lat,
  end_lon = data_original$end_lng,
